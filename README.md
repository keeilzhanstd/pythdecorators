...
***
Представим, вы владелец огромного поля с яблонями. Яблонь очень много, потому у вас появился новенький робот собирающий яблоки, и отсеивающий гнилые.  Прикинем, что по статистике, каждое третье яблоко сгнившее. Тогда робот будет выполнять следущее: 
###### Code
...
Перед тем как закончить хочу вам показать самый полезный *Встроенный* декоратор из стандартной библиотеки Python.
